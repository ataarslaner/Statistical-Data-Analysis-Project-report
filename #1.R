...
#H0: There is no relationship between two variables. The variables are independent of each other
#H1: There is a relationship between two variables. The variables are dependent upon each other .
...
#Since the X-squared value is lower than Critical value , we failed to reject the null hypothesis. As conclusion there is no relationship between smokers and their regions.



#Independence Test for Sex and Smoker columns
#H0 : There is no difference in proportion of smokers between genders
#H1 : There is difference in proportion of smokers between genders
tbl2=table(data$sex,data$smoker)
chisq.test(tbl2,correct=FALSE,c)
#Critical point is 3.84 since degrees of freedom is 1.
#Since the X-squared value greater than the critical value , we reject the null hypothesis and accept the alternative hypothesis and conclude as there is difference in proportions of smokers according to gender.
